...
```
        ...
        ▼                        ▼                        ▼
┌───────────────┐      ┌───────────────┐      ┌───────────────┐
│ Skills Engine │      │ Chat Service  │      │ Podcast Svc   │
│               │      │               │      │               │
...
**核心 Agent 能力：**
- **记忆持久化** — 长期记忆用户偏好，短期记忆对话上下文
- **Skills & Tools** — 可扩展工具系统，支持天气、日历、邮件等
- **智能对话** — 上下文感知，记忆检索，多轮对话
- **自动化** — 定时任务，自动生成播客，行为驱动推荐

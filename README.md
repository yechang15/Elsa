...
核心流程：
1. 用户选择兴趣话题 → RSSService 订阅源
2. SchedulerService 定时触发 → RSSService 拉取内容
3. PodcastService 调用 LLMService 生成对话脚本
4. TTSService 合成语音 → AudioPlayer 播放
5. BehaviorTracker 记录行为 → MemoryManager 更新偏好
6. SkillsEngine 根据 Skill 规则调用 AgentTool（天气/日历等）
```
